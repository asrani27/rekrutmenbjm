...
@section('content')
    ...
    <div class="col-lg-2">
        @if ($data->file_foto == null)
            <div class="img-responsive img-responsive-1x1 rounded-3 border" style="background-image: url(/icon/person.gif)">
            </div>
        @else
            <div class="img-responsive img-responsive-1x1 rounded-3 border"
                style="background-image: url('/storage/foto/{{ $data->file_foto }}')"></div>
        @endif
        <br />
            ...
            <div class="card-body">
                <dl class="row">
                    ...
                    @if ($data->status_kirim == 2 && $isAvailable)
                        ...
                        <dd class="col-12">
                            <div class="alert alert-success">
                                ...
                                tombol panduan dan materi sosialisasi untuk langkah-langkah selanjutnya.
                            </div>
                    ...
                    @if ($data->status_kirim == 3)
                        <dt class="col-3">STATUS</dt>
                        <dd class="col-9">: <span class="badge badge-outline text-red">TIDAK LOLOS</span></dd>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter table-bordered table-nowrap card-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>FOTO FORMAL</td>
                        <td class="text-center"><a href="/storage/foto/{{ $data->file_foto }}" target="_blank">JPG</a>
                        </td>
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                            @if ($data->file_foto == null)
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="icon text-red">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                            @if ($data->file_foto != null)
                                <a href="/storage/foto/{{ $data->file_foto }}" class="btn btn-md btn-outline-primary"
                                    target="_blank">Preview</a>
                            @endif
                            @if ($data->status_kirim == 0 || $data->status_kirim == null)
                                <button type="button" class="btn btn-md btn-outline-primary uploadfile" data-id="123"
                                    data-jenis="foto">upload</button>
                            @endif
                        </td>
                    </tr>
                    <tr>
                        <td>FOTO CASUAL <br /><small>yang akan di tampilkan di instagram</small></td>
                        <td class="text-center"><a href="/storage/pose/{{ $data->file_pose }}" target="_blank">JPG</a>
                        </td>
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                        ...
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                            @if ($data->file_pose != null)
                                <a href="/storage/pose/{{ $data->file_pose }}" class="btn btn-md btn-outline-primary"
                                    target="_blank">Preview</a>
                            @endif
                            @if ($data->status_kirim == 0 || $data->status_kirim == null)
                                <button type="button" class="btn btn-md btn-outline-primary uploadfile" data-id="123"
                                    data-jenis="pose">upload</button>
                            @endif
                        </td>
                    </tr>
                    <tr>
                        <td>KTP</td>
                        <td class="text-center"><a href="/storage/ktp/{{ $data->file_ktp }}" target="_blank">JPG</a>
                        </td>
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                        ...
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                            @if ($data->file_ktp != null)
                                <a href="/storage/ktp/{{ $data->file_ktp }}" class="btn btn-md btn-outline-primary"
                                    target="_blank">Preview</a>
                            @endif
                            @if ($data->status_kirim == 0 || $data->status_kirim == null)
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="/storage/pdf/{{ $data->file_ijazah }}" target="_blank">PDF</a>
                        </td>
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                        ...
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                            @if ($data->file_ijazah != null)
                                <a href="/storage/pdf/{{ $data->file_ijazah }}" class="btn btn-md btn-outline-primary"
                                    target="_blank">Preview</a>
                            @endif
                            @if ($data->status_kirim == 0 || $data->status_kirim == null)
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="/storage/pdf/{{ $data->file_sertifikat }}"
                        ...
                        <td class="text-center"><!-- Download SVG icon from http://tabler-icons.io/i/check -->
                            @if ($data->file_sertifikat != null)
                                <a href="/storage/pdf/{{ $data->file_sertifikat }}"
                                    class="btn btn-md btn-outline-primary" target="_blank">Preview</a>
                            @endif
                            @if ($data->status_kirim == 0 || $data->status_kirim == null)
                                <a href=# class="btn btn-md btn-outline-primary uploadpdf"
                                    data-jenis="SERTIFIKAT">upload</a>
                            @endif
                        </td>
                    </tr>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="/user/home/upload" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="file" name="file" id="file" class="form-control" accept="image/jpg"
                            required>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="/user/home/upload" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="file" name="file" id="filepdf" class="form-control"
    ...
    @if ($data->status_kirim == 0 || $data->status_kirim == null)
        <button class='btn btn-primary btn-lg w-100 kirimlamaran'> <svg xmlns="http://www.w3.org/2000/svg" width="24"
...
@push('js')
    ...
    <script>
        ...
        Swal.fire({
            ...
            text: 'Dipublikasikan pada tanggal 6 November 2024. Kandidat program #BanjarmasinMemanggil dipersilahkan untuk mengecek di https://rekrutmen.banjarmasinmemanggil.com  secara berkala.',
            icon: 'info',
        })

      ...
      <div class="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center">
        <div class="container container-tight my-5 px-lg-5">
          ...
          <h1 class="h1 text-center mb-3">
            Registrasi telah selesai. Formulir ini <b class="text-danger">dinonaktifkan</b>.
          </h1>
          <form action="/register" method="post" autocomplete="off" novalidate class="form-register" style="display: none">
            @csrf
            <div class="mb-3">
              <label class="form-label">Nama Anda</label>
              <input type="text" class="form-control @error ('nama') is-invalid @enderror" name="nama" value="{{old('nama')}}"  placeholder="Nama Anda" autocomplete="new-password" required>
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control @error ('email') is-invalid @enderror" name="email" value="{{old('email')}}" placeholder="emailanda@gmail.com" autocomplete="off">
              @error ('email')
                <div class="invalid-feedback">{{$message}}</div>
              @enderror
            </div>
            ...
            <div class="mb-3">
              <label class="form-label">Password</label>
                <input type="password" class="form-control @error ('password') is-invalid @enderror" name="password" placeholder="Password anda"  autocomplete="new-password" required>
                @error ('password')
                <div class="invalid-feedback">{{$message}}</div>
                @enderror
            </div>
            <div class="mb-3">
              ...
              <input type="password" class="form-control @error ('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="Ulangi password"  autocomplete="off" required >
            ...
            <div class="form-footer">
              <button type="submit" class="btn btn-primary w-100 button-register">Daftar</button>
            </div>
          ...
          <div class="text-center text-secondary mt-3">
            Anda Sudah Memiliki Akun ? <a href="/login" tabindex="-1"><strong>Log in disini</strong></a>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
        <!-- Photo -->
        <div class="bg-cover h-100 min-vh-100" style="background-image: url('/icon/tm2.jpg')">
        </div>
      </div>
    </div>
    <!-- Libs JS -->

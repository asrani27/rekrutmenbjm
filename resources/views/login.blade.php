  ...
  <body  class=" d-flex flex-column bg-white">
    ...
    <div class="row g-0 flex-fill">
      <div class="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center">
        <div class="container container-tight my-5 px-lg-5">
          <div class="text-center mb-4">
            <a href="#" class="navbar-brand navbar-brand-autodark"><img src="/icon/bjmmemanggil.png" alt=""></a>
          </div>
          ...
          <div class="text-center text-secondary mt-3">
            New on our platform? <a href="/register" tabindex="-1"><strong>Create an account</strong></a>
          </div>
      ...
      <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
        <!-- Photo -->
        <div class="bg-cover h-100 min-vh-100" style="background-image: url('/icon/bg2.jpg')">
        </div>
      </div>
    </div>
    <!-- Libs JS -->
